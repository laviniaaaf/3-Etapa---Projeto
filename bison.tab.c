...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_VAR = 3,                      /* T_VAR  */
  YYSYMBOL_T_FLOAT = 4,                    /* T_FLOAT  */
  YYSYMBOL_T_CHAR = 5,                     /* T_CHAR  */
  YYSYMBOL_T_STRING = 6,                   /* T_STRING  */
  YYSYMBOL_T_OPARI = 7,                    /* T_OPARI  */
  YYSYMBOL_T_ASSIGN = 8,                   /* T_ASSIGN  */
  YYSYMBOL_T_SEMICOLON = 9,                /* T_SEMICOLON  */
  YYSYMBOL_T_ENTRADA = 10,                 /* T_ENTRADA  */
  YYSYMBOL_T_SAIDA = 11,                   /* T_SAIDA  */
  YYSYMBOL_T_KEYWORD = 12,                 /* T_KEYWORD  */
  YYSYMBOL_T_PROGRAMA = 13,                /* T_PROGRAMA  */
  YYSYMBOL_T_PREX = 14,                    /* T_PREX  */
  YYSYMBOL_T_CHAVESOPEN = 15,              /* T_CHAVESOPEN  */
  YYSYMBOL_T_CHAVESCLOSE = 16,             /* T_CHAVESCLOSE  */
  YYSYMBOL_T_PARENTESISOPEN = 17,          /* T_PARENTESISOPEN  */
  YYSYMBOL_T_PARENTESISCLOSE = 18,         /* T_PARENTESISCLOSE  */
  YYSYMBOL_T_COMMA = 19,                   /* T_COMMA  */
  YYSYMBOL_YYACCEPT = 20,                  /* $accept  */
  YYSYMBOL_programa = 21,                  /* programa  */
  YYSYMBOL_declara_variaveis = 22,         /* declara_variaveis  */
  YYSYMBOL_variavel = 23,                  /* variavel  */
  YYSYMBOL_varias_variaveis = 24,          /* varias_variaveis  */
  YYSYMBOL_bloco_codigos = 25,             /* bloco_codigos  */
  YYSYMBOL_codigo = 26,                    /* codigo  */
  YYSYMBOL_entradaSaida = 27,              /* entradaSaida  */
  YYSYMBOL_expressao = 28,                 /* expressao  */
  YYSYMBOL_operandos = 29,                 /* operandos  */
  YYSYMBOL_entrada = 30,                   /* entrada  */
  YYSYMBOL_lista_entradas = 31,            /* lista_entradas  */
  YYSYMBOL_saida = 32,                     /* saida  */
  YYSYMBOL_lista_saidas = 33               /* lista_saidas  */
};
...
static const yytype_int8 yyrline[] =
{
      ...
      40,    43,    44,    45,    46,    49,    52,    53,    56,    57,
      62,    69,    70,    73,    76,    77,    80,    83,    84
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "T_VAR", "T_FLOAT",
  "T_CHAR", "T_STRING", "T_OPARI", "T_ASSIGN", "T_SEMICOLON", "T_ENTRADA",
  "T_SAIDA", "T_KEYWORD", "T_PROGRAMA", "T_PREX", "T_CHAVESOPEN",
  "T_CHAVESCLOSE", "T_PARENTESISOPEN", "T_PARENTESISCLOSE", "T_COMMA",
  "$accept", "programa", "declara_variaveis", "variavel",
  "varias_variaveis", "bloco_codigos", "codigo", "entradaSaida",
  "expressao", "operandos", "entrada", "lista_entradas", "saida",
  "lista_saidas", YY_NULLPTR
};
